...
app.post("/signup", async (req, res) => {
  ...
  try {
    ...
    // doing this to decouple our app from other app
...
app.post("/login", async (req, res) => {
  ...
  // right now the auth is working with kubernetes ("http://auth/token")
  // because of this: (docker-compose.yaml)
  // services:
  // auth:
